...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddDbContext<SystemZarzadzaniaSchroniskiemDbContext>(options =>
        {
        ...
        .AddEntityFrameworkStores<SystemZarzadzaniaSchroniskiemDbContext>()
        ...
        services.AddScoped<BugReportService>(provider => {
            var context = provider.GetRequiredService<SystemZarzadzaniaSchroniskiemDbContext>();
